...
#
# class transferAdmin(admin.transfer):
#
#     list_display = ('id', 'name', 'create_time')
@admin.register(transfer)
# class RecordAdmin(admin.ModelAdmin):
# class RecordAdmin(ImportExportModelAdmin):
# name = models.CharField(max_length=128, verbose_name='付款人',null=True  )
#
...
# Reveivename = models.CharField(max_length=128, verbose_name='收款人',null=True )
class RecordAdmin(ImportExportActionModelAdmin):


    list_display = ('id', 'name','money','gender','Reveivename', 'create_time')
    list_per_page = 10
